...
public class SwayRotator : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            _originalPosition = myTransform.localRotation.eulerAngles;
        }
        else
        {
    ...
    private void Update()
    {
        ...
        if (useLocalPosition == true)
        {
            myTransform.localRotation = Quaternion.Euler(_originalPosition + position);
        }
        else
        {
